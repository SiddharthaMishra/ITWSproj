...
<body>
  ...
  <?php if (!isset($_SESSION['login_user'])) : ?> 
    ...
    <input type="text" id="year" style= "height:20px;width:200px"name="year" value="<?php if(isset($year)) echo $year; else echo ''; ?>" onchange="changeDays(document.getElementById('month').value,this.value);">
    <script>
    ...
    <input type="password" id="pass" pattern=".{5,}" name="password" placeholder="password" required><br>
    <input type="password" id="ch_pass" pattern=".{5,}" name="new_password" placeholder="confirm password" required><br>      
    <input type="submit" id="subForm" name="submit" value="Sign Up" disabled >
